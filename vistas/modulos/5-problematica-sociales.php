        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnInformeArea" area="problematica" periodo="'.$_SESSION['periodo'].'" idCurso=11 idCurso2=12 idCurso3=0 idCurso4=0 modalidad="Ciencias Sociales y Humanidades" tabla="quinto" informe="informe-area-orientacion">
