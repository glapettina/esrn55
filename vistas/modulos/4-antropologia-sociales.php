        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnInformeArea" area="antropologia4" periodo="'.$_SESSION['periodo'].'" idCurso=9 idCurso2=10 idCurso3=0 idCurso4=0 modalidad="Ciencias Sociales y Humanidades" tabla="cuarto" informe="informe-area-orientacion">
