...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        4er. Año - Ciencias Naturales - Física Ambiental
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">4er. Año - Ciencias Naturales - Física Ambiental</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnInformeArea" area="fisica" periodo="'.$_SESSION['periodo'].'" idCurso=14 idCurso2=15 idCurso3=0 idCurso4=0 modalidad="Ciencias Naturales" tabla="cuarto" informe="informe-area-orientacion">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeFisicao" nombreAlumno="'.$value["nombre"].'" tabla="cuarto" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" periodo="'.$_SESSION['periodo'].'" tabla="cuarto" area="fisica" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
      ...
      <form role="form" method="post" id="modalInforme">
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
         ...
         <?php
              ...
              $editarInforme -> ctrEditarInformeFisicao($tabla, $curso);
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
         ...
         <?php
              ...
              $copiaSaberes -> ctrCopiarSaberesFisicao($tabla, $curso, $ncurso1, $ncurso2, $periodo);
