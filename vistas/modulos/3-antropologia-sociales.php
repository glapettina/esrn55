...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        3er. Año - Ciencias Sociales - Antropología Cultural
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">3er. Año - Ciencias Sociales - Antropología Cultural</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=7 idCurso2=8 tabla="tercero" data-toggle="modal" data-target="#modalCopiaSaberes">
                  
                  Copia Saberes
                </button>

                <button class="btn btn-primary btnInformeArea" area="antropologia3" periodo="'.$_SESSION['periodo'].'" idCurso=7 idCurso2=8 idCurso3=0 idCurso4=0 modalidad="Ciencias Sociales y Humanidades" tabla="tercero" informe="informe-area-orientacion">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeAntropologia3" nombreAlumno="'.$value["nombre"].'" tabla="tercero" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" periodo="'.$_SESSION['periodo'].'" tabla="tercero" area="antropologia3" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
      ...
      <form role="form" method="post" id="modalInforme">
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
         ...
         <?php
              ...
              $editarInforme -> ctrEditarInformeAntropologia3($tabla, $curso);
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="copiaSaberesAntropologia3">Saberes</label>
                      <textarea class="form-control" cols="80" rows="6" id="copiaSaberesAntropologia3" name="copiaSaberesAntropologia3">
                  </textarea>
              </div>
         ...
         <?php
              ...
              $copiaSaberes -> ctrCopiarSaberesAntropologia3($tabla, $curso, $ncurso1, $ncurso2, $periodo);
