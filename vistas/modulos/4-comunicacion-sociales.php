...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        4to. Año - Ciencias Sociales - Comunicación y Sociedad
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">4to. Año - Ciencias Sociales - Comunicación y Sociedad</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=9 idCurso2=10 tabla="cuarto" data-toggle="modal" data-target="#modalCopiaSaberes">
                  
                  Copia Saberes
                </button>

                <button class="btn btn-primary btnInformeArea" area="comunicacion" periodo="'.$_SESSION['periodo'].'" idCurso=9 idCurso2=10 idCurso3=0 idCurso4=0 modalidad="Ciencias Sociales y Humanidades" tabla="cuarto" informe="informe-area-orientacion">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeComunicacion" nombreAlumno="'.$value["nombre"].'" tabla="cuarto" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" periodo="'.$_SESSION['periodo'].'" tabla="cuarto" area="comunicacion" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                  <select class="form-control input-lg" id="asistenciaComunicacion" name="asistenciaComunicacion">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
         ...
         <?php
              ...
              $copiaSaberes -> ctrCopiarSaberesComunicacion($tabla, $curso, $ncurso1, $ncurso2, $periodo);
